    ...
    const singupData = async(e)=>{
        ...
        try{
            ...
            if(data.img == undefined){
                await setDoc(doc(db,"users",id),{...data,timeStamp:serverTimestamp(),img:"https://firebasestorage.googleapis.com/v0/b/chat-e267f.appspot.com/o/default_image.webp?alt=media&token=c3259abe-b0af-478d-9110-0c46a5035dba"});
            }else{
        ...
        <div className='form'>
            <form onSubmit={(e)=>{
                ...
                <div className='input-control'>
                    ...
                    <div>
                        <img src={file?file:"https://firebasestorage.googleapis.com/v0/b/chat-e267f.appspot.com/o/default_image.webp?alt=media&token=c3259abe-b0af-478d-9110-0c46a5035dba"} alt="personalImage"/>
